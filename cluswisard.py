...
if __name__ == "__main__":
    print("="*60)
    print(f" BENCHMARK: PIPELINE CLUSWISARD ({NUM_EXECUCOES} EXECUÇÕES)")
    print("="*60)
    ...
    print("[Fase 1] Carregando e Extraindo Dados de Treino Base...")
    ...
    print("[Fase 2] Pré-processando Dados de Teste em Cache...")
    cache_teste = []
    tot_gab_global = 0
    todos_gabaritos_map = {}
    ...
    # =========================================================================
    print(f"[Fase 3] Iniciando o ciclo de {NUM_EXECUCOES} rodadas...")
    ...
    for rodada in range(NUM_EXECUCOES):
        ...
        if f1_r > melhor_f1_global:
            ...
            # Limpa imagens mentais antigas antes de salvar as novas
            ...
            for classe, cluster in patterns.items():
                for index, discriminator in enumerate(cluster):
                    ...
                    if imagens_concatenadas:
                        ...
                        nome_arquivo = os.path.join(pasta_mental, f"{classe}_disc_{index}_{MODO_BINARIZACAO}.png")
    ...
    relatorio_json = {
        "configuracoes": {
            ...
            "cluswisard_min_score": MIN_SCORE,
    ...
    nome_arquivo_json = os.path.join(pasta_saida, "relatorio_benchmark_cluswisard.json")
